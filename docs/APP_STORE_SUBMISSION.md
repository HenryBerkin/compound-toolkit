...
| Apple Developer Team, signing ownership, Account Holder access | **Open owner input — activation pending** | Programme enrolment is complete, but Team Name and Team ID are not yet available. Confirm both before project creation. Do not share individual credentials, use a Personal Team, or invent a team. |
