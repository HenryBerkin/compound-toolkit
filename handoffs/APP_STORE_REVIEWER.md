...
Submission work has not started. IGC-008 remains Proposed until product scope and native
data handling are accepted. Current evidence indicates local-only scenario data, no
